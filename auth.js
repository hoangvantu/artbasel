...
var tempUserTop = function(data) {
    return '<ul class="nav navbar-nav navbar-right"><li><a href="javascript:void(0)"> <img class="thumAvatar" src="' + apiBaseURL + "/" + data.avatar +'"> '+ data.lastName + ' ' + data.firstName + 
        '</a></li><li><a href="javascript:void(0)" onclick="logout()">Logout</a></li></ul>';
};

function logout () {
    var expires = "expires=Thu, 01 Jan 1970 00:00:00 UTC";
    document.cookie = 'tokenId='+getCookie('tokenId')+ ';' + expires;
    location.reload(); 
}
...
function getCurrentUser(){
    ...
    $.ajax({
        ...
        success: function(data) {
            // console.log(data);       
            $(tempUserTop(data)).replaceAll(".userTop ul");
        },
        error: function(err) {
            console.log(err);
        }
